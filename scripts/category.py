...
class CategoryAddBot(MultipleSitesBot):
    ...
    def treat(self, page):
        ...
        if catpl in cats:
            ...
            # TODO: cannot add category into a template document with no category existed currently
            if page.namespace() == 10 and cats and includeonly == ['includeonly']:
                    last_old_cat = cats[-1]
                    text = textlib.replaceCategoryInPlace(text, last_old_cat, catpl,
