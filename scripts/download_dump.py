...
class DownloadDumpBot(Bot):
    ...
    def run(self):
        ...
        while True:
            ...
            download_filename = self.getOption('wikiname') + '-latest-' + self.getOption('filename')
            download_path = self.getOption('wikiname') + '/latest/' + download_filename
            ...
            if os.path.isfile(toolforge_dump_path):
                copyfile(toolforge_dump_path, self.getOption('storepath') + download_filename)
                ...
                if response.status_code == 200:
                    with open(self.getOption('storepath') + download_filename, 'wb') as f:
