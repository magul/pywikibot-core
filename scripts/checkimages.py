...
class checkImagesBot(object):
    ...
    def takesettings(self):
        ...
        page_title = i18n.translate(self.site, page_with_settings)
        if page_title:
            testo = pywikibot.Page(self.site, page_title).text
            if not testo:
                pywikibot.output(
                    'Either the settings page does not exist or it is empty!')
                return
