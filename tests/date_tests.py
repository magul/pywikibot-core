...
class TestMonthDelta(TestCase):
    ...
    def test_get_delta(self):
        ...
        self.assertEqual(date.get_month_delta(
            datetime(2012, 1, 31), datetime(2012, 3, 31)), 2)
        self.assertEqual(date.get_month_delta(
            datetime(2012, 3, 31), datetime(2012, 1, 31)), -2)
        self.assertEqual(date.get_month_delta(
            datetime(2012, 3, 31), datetime(2013, 1, 31)), 10)
        self.assertEqual(date.get_month_delta(
            datetime(2014, 3, 31), datetime(2013, 3, 31)), -12)
