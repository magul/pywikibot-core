...
class TestCosmeticChangesISBN(DefaultDrySiteTestCase):
    ...
    ISBN_CHECKSUMERROR_RE = 'The ISBN checksum of [0-9]+ is incorrect.'
    ISBN_INVALIDCHARACTERSERROR_RE = 'The ISBN [0-9a-zA-Z]+ contains invalid characters.'
    ...
    def test_invalid_isbn(self):
        ...
        # Invalid checksum
        self.assertRaisesRegex(AnyIsbnValidationException,
                               self.ISBN_CHECKSUMERROR_RE, cc.fix_ISBN, 'ISBN 0975229801')
        # Invalid length
        self.assertRaisesRegex(AnyIsbnValidationException,
                               self.ISBN_DIGITERROR_RE, cc.fix_ISBN, 'ISBN 09752298')
        # X in the middle
        self.assertRaisesRegex(AnyIsbnValidationException,
                               self.ISBN_INVALIDCHARACTERSERROR_RE, cc.fix_ISBN, 'ISBN 09752X9801')
