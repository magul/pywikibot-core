...
class TestTimeStripperTreatSpecialText(TestTimeStripperCase):
    ...
    def test_timestripper_match_comment(self):
        ...
        self.assertEqual(ts.comment_pattern.search(txt_match).group(1),
                         exp_match)
    ...
    def test_timestripper_match_hyperlink(self):
        ...
        self.assertEqual(ts.hyperlink_pat.search(txt_match).group(),
                         exp_match)
    ...
    def test_timestripper_match_wikilink(self):
        ...
        self.assertEqual(ts.wikilink_pat.search(txt_match).group('link'),
                         exp_match_link)
        self.assertEqual(ts.wikilink_pat.search(txt_match).group('anchor'),
                         exp_match_anchor)
