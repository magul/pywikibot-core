...
from tests import unittest_print, testwiki_cache
...
class TokenTestBase(TestCaseBase, unittest.TestCase):
...
class TestSiteGenerators(DefaultSiteTestCase):
    ...
    def test_pagetemplates(self):
        ...
        with testwiki_cache('&generator=templates', 'test_pagetemplates_all'):
            pagetemplates_all = set(self.site.pagetemplates(self.mainpage))
        with testwiki_cache('&generator=templates', 'test_pagetemplates_10'):
    ...
    def test_pagelinks(self):
        """Test Site.pagelinks."""
        with testwiki_cache('&generator=links', 'test_pagelinks_all'):
            links = set(self.site.pagelinks(self.mainpage))
        for pl in links:
            self.assertIsInstance(pl, pywikibot.Page)
        with testwiki_cache('&generator=links', 'test_pagelinks_10'):
            namespace_links = set(
