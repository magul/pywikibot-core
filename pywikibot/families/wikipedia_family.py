...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'min', 'kk', 'hy', 'sk', 'zh-min-nan', 'he', 'lt', 'hr', 'ce',
            'et', 'sl', 'be', 'gl', 'nn', 'el', 'uz', 'la', 'simple', 'vo',
            'ur', 'hi', 'az', 'th', 'ka', 'ta', 'cy', 'mk', 'mg', 'oc', 'lv',
            'bs', 'new', 'tt', 'tg', 'tl', 'te', 'ky', 'sq', 'pms', 'br',
            'be-tarask', 'zh-yue', 'ht', 'jv', 'bn', 'ml', 'ast', 'lb', 'mr',
            'af', 'pnb', 'sco', 'is', 'ga', 'cv', 'ba', 'fy', 'sw', 'my', 'lmo',
            'an', 'yo', 'ne', 'gu', 'io', 'nds', 'scn', 'pa', 'bpy', 'ku',
            'als', 'bar', 'kn', 'qu', 'ia', 'su', 'ckb', 'mn', 'arz', 'bat-smg',
            'azb', 'nap', 'wa', 'gd', 'bug', 'yi', 'am', 'map-bms', 'si', 'or',
            'fo', 'mzn', 'li', 'sah', 'sa', 'hsb', 'vec', 'mai', 'ilo', 'os',
            'mrj', 'hif', 'xmf', 'mhr', 'roa-tara', 'bh', 'eml', 'pam', 'ps',
            'nso', 'diq', 'nah', 'sd', 'hak', 'se', 'mi', 'bcl', 'nds-nl',
            'gan', 'glk', 'zh-classical', 'vls', 'rue', 'bo', 'wuu', 'szl',
            'sc', 'fiu-vro', 'co', 'vep', 'lrc', 'tk', 'crh', 'csb', 'kv', 'km',
            'gv', 'frr', 'as', 'lad', 'so', 'zea', 'cdo', 'ace', 'ay', 'udm',
            'lez', 'kw', 'stq', 'myv', 'nrm', 'ie', 'koi', 'pcd', 'rm', 'ug',
            'gom', 'lij', 'mt', 'fur', 'gn', 'dsb', 'dv', 'cbk-zam', 'ext',
            'ang', 'kab', 'nv', 'ksh', 'mwl', 'ln', 'gag', 'sn', 'frp', 'pag',
            'pi', 'av', 'xal', 'pfl', 'olo', 'krc', 'haw', 'bxr', 'kaa', 'rw',
            'pdc', 'pap', 'bjn', 'to', 'nov', 'kl', 'lo', 'arc', 'jam', 'kbd',
            'ha', 'tyv', 'tet', 'tpi', 'ki', 'ig', 'na', 'ab', 'lbe', 'roa-rup',
            'jbo', 'ty', 'kg', 'mdf', 'za', 'lg', 'wo', 'srn', 'zu', 'bi',
            'ltg', 'chr', 'tcy', 'sm', 'om', 'tn', 'chy', 'xh', 'tw', 'cu',
            'rmy', 'tum', 'pih', 'rn', 'got', 'pnt', 'bm', 'ss', 'ch', 'ady',
            'ts', 'iu', 'st', 'ny', 'fj', 'ee', 'ak', 'ks', 'ik', 'sg', 've',
            'dz', 'ff', 'ti', 'cr',
        ]
