...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'hy', 'min', 'kk', 'zh-min-nan', 'sk', 'he', 'lt', 'hr',
            'ce', 'et', 'sl', 'be', 'gl', 'nn', 'el', 'uz', 'la', 'simple',
            'ur', 'az', 'vo', 'hi', 'th', 'ka', 'ta', 'cy', 'mk', 'oc', 'mg',
            'lv', 'bs', 'tl', 'new', 'tt', 'ky', 'tg', 'te', 'sq', 'pms', 'br',
            'be-tarask', 'zh-yue', 'ml', 'ht', 'bn', 'jv', 'lb', 'ast', 'mr',
            'af', 'sco', 'pnb', 'is', 'ga', 'cv', 'ba', 'fy', 'su', 'sw', 'my',
            'lmo', 'an', 'yo', 'ne', 'azb', 'gu', 'io', 'nds', 'pa', 'scn',
            'bpy', 'als', 'ku', 'bar', 'kn', 'ia', 'qu', 'ckb', 'mn', 'arz',
            'bat-smg', 'wa', 'gd', 'nap', 'bug', 'yi', 'am', 'si', 'map-bms',
            'cdo', 'or', 'fo', 'mzn', 'li', 'hsb', 'mai', 'sah', 'sa', 'vec',
            'ilo', 'os', 'xmf', 'mrj', 'hif', 'mhr', 'roa-tara', 'bh', 'eml',
            'diq', 'pam', 'ps', 'sd', 'nso', 'hak', 'se', 'bcl', 'mi', 'nah',
            'nds-nl', 'zh-classical', 'gan', 'vls', 'rue', 'wuu', 'szl', 'bo',
            'glk', 'vep', 'sc', 'fiu-vro', 'co', 'lrc', 'crh', 'km', 'tk',
            'kv', 'csb', 'frr', 'gv', 'as', 'so', 'ace', 'lad', 'zea', 'ay',
            'udm', 'myv', 'lez', 'kw', 'stq', 'ie', 'nrm', 'mwl', 'pcd', 'nv',
            'koi', 'rm', 'gom', 'ug', 'lij', 'mt', 'gn', 'fur', 'dsb',
            'cbk-zam', 'dv', 'ang', 'ln', 'ext', 'kab', 'ksh', 'sn', 'gag',
            'lo', 'frp', 'pag', 'pi', 'av', 'olo', 'ab', 'xal', 'pfl', 'krc',
            'haw', 'bxr', 'kaa', 'rw', 'pdc', 'pap', 'bjn', 'to', 'nov', 'kl',
            'arc', 'jam', 'kbd', 'dty', 'ha', 'tyv', 'tet', 'tpi', 'ig', 'ki',
            'na', 'lbe', 'roa-rup', 'jbo', 'ty', 'kg', 'mdf', 'za', 'wo', 'lg',
            'bi', 'srn', 'zu', 'ltg', 'tcy', 'chr', 'sm', 'om', 'xh', 'tn',
            'chy', 'rmy', 'tw', 'cu', 'tum', 'pih', 'st', 'rn', 'got', 'ts',
            'pnt', 'ss', 'bm', 'ch', 'ady', 'iu', 'fj', 'ny', 'ee', 'kbp',
            'ks', 'ak', 'ik', 'sg', 've', 'dz', 'ff', 'ti', 'cr', 'atj',
        ]
