...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'nn', 'co', 'pnb', 'lv', 'mn', 'ka', 'sl', 'sq', 'nds', 'nah', 'lb',
            'bs', 'sa', 'kk', 'tk', 'km', 'sm', 'mk', 'hsb', 'bn', 'be', 'ms',
            'pa', 'ga', 'ur', 'an', 'wo', 'vec', 'ang', 'tt', 'sd', 'gn', 'mr',
            'so', 'csb', 'ug', 'gd', 'mt', 'st', 'roa-rup', 'si', 'ia', 'ie',
            'ay', 'mi', 'kl', 'jbo', 'fo', 'ln', 'zu', 'na', 'gu', 'gv', 'kw',
