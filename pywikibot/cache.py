# -*- coding: utf-8 -*-
"""
The following file is taken from werkzeug 0.9.4, with minor modifications
to remove any dependencies upon all of werkzeug.
Unlike the rest of pywikibot, it is released under the BSD license.
    ...
    >>> from pywikibot.cache import SimpleCache
    >>> c = SimpleCache()
    >>> c.set("foo", "value")
    >>> c.get("foo")
    'value'
