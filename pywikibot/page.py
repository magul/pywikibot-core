...
class BasePage(UnicodeMixin, ComparableMixin):
    ...
    def permalink(self, oldid=None, percent_encoded=True, show_protocol=False):
        ...
        @param oldid: The revid of the revision desired.
        @param percent_encoded: if false, the link will be provided without title uncoded.
        @param show_protocol: if true, http or https prefixes will be included, before the double
            slash.
        @rtype: unicode
        """
        if percent_encoded:
