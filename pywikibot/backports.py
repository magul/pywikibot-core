...
class Counter(dict):
    ...
    def fromkeys(cls, iterable, v=None):
        """Raise error to show that this methode is not implemented."""
    ...
    def update(*args, **kwds):
        """Like the dict.update but add counts instead of replacing them.
    ...
    def __reduce__(self):
        """Return the data for pickling."""
        return self.__class__, (dict(self),)

    def __delitem__(self, elem):
        """Call dict.__delitem__ but do not raise KeyError."""
        if elem in self:
    ...
    def __neg__(self):
        """Subtract from an empty counter.
